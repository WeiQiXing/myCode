<template>
  <div id="app">
    ...
    <el-container style="height: 850px; width: 100%; boder: 1px solid #eee">
      <el-aside width="200px" style="background-color: rgb(238,241,246)">
        <el-menu :default-openeds="['1', '2', '3']">
          <el-submenu index="1">
            <template slot="title"><i class="el-icon-s-home"></i>基础简介</template>
            <el-menu-item-group>
          ...
          <el-submenu index="2">
            <template slot="title"><i class="el-icon-menu"></i>控件实践</template>
            <el-menu-item-group>
              ...
              <el-menu-item index="2-4" @click="gotoCesRec"><b>Cesium</b></el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="3">
            <template slot="title"><i class="el-icon-document"></i>学习记录</template>
            <el-menu-item-group>
              <el-menu-item index="3-1" @click="gotoHTML"><b>HTML</b></el-menu-item>
...
export default {
  ...
  window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function
  (func) {
